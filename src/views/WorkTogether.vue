    ...
    >
      ...
      <div class="email-contact social-contact-info">
        <div class="icon-container">
          <img src="../assets/email-img.png" alt="" class="socials-img" />
        </div>
        <h3 class="info-social-title">email us</h3>
        <h2 class="info-social-contact">lila@relationship-ready.co.uk</h2>
      </div>
      <div class="insta-contact social-contact-info">
        <div class="icon-container">
          <img src="../assets/ig-img.png" alt="" class="socials-img" />
        </div>
      ...
      <div class="facebook-contact social-contact-info">
        <div class="icon-container">
          <img src="../assets/fb-img.png" alt="" class="socials-img" />
        </div>
