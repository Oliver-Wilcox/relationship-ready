<template>
  <div class="nav">
    <div class="bg-blur" v-bind:class="{ blurActive: isBurgerActive }"></div>
    <div
      class="navigation-container"
      v-bind:class="{ navActive: isBurgerActive }"
    >
      <div class="menu-items" v-bind:class="{ menuTextActive: isBurgerActive }">
        <span class="menu-cont"
          ><h3 class="menu" v-bind:class="{ menuActive: isBurgerActive }">
            MENU
          </h3></span
        >
...
export default {
  ...
  methods: {
    ...
    timelineHome() {
      ...
      const mySplitText = new SplitText(this.$refs.homeText, { type: "lines" });
    ...
    timelineWho() {
      const tl = gsap.timeline();
      const mySplitText = new SplitText(this.$refs.whoText, { type: "lines" });
      const lines = mySplitText.lines;
    ...
    timelineFb() {
      const tl = gsap.timeline();
      const mySplitText = new SplitText(this.$refs.fbText, { type: "lines" });
      const lines = mySplitText.lines;
